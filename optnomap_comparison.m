% Welfare and stability numbers comparing
% alternative monetary policy rules to OptNoMap
%
...
s.verbose = 0;
L1s = s;
[rule1_sols{6}, rule1_sumstats{6}] = geteqm(L1s);
rule1_stats.welfare(6) = consumption_equiv(rule1_sumstats{6}.ergodic.ExpV, rule1_sumstats{1}.ergodic.ExpV, L1s.r);
rule1_stats.stab_frac(6) = rule1_sumstats{6}.ergodic.stab_frac - rule1_sumstats{1}.ergodic.stab_frac;
rule1_stats.stab_frac_pct50(6) = rule1_sumstats{6}.ergodic.stab_frac_pct50 - rule1_sumstats{1}.ergodic.stab_frac_pct50;
...
policy_names = {'OptNoMaP', 'i = optimal iput', 'i = optimal ilaw', 'i = Friedman with pos. lambda', 'inflation targeting','Calibration'}; % 'higher LAW', 'lower LAW', 'higher Put'};
for i = 1:n_comps
