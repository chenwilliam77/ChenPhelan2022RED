...
savepath = [pwd(), '/../save/output_data/max_expV_fedput_4args_icc6/'];
if ~isdir(savepath)
    mkdir(savepath);
end
...
% Set up
lc_icc_calibration_parameters;
s.plot_results = 0;
s.verbose = 0;
s.max_expV = 1;
s.leverage_constraint.alpha = 6;
...
ub = [.04; s.imax; .05; .10];
algo = 'interior-point';
Ns = [5, 5, 6, 6]; % dimension of initial guesses w/in hyper cube specified by lb and ub
