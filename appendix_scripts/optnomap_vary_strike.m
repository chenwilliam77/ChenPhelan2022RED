...
% (2) etaLAW lower than Optimal Fed Put
%
% Written by William Chen and Gregory Phelan, Jun. 2021
...
figurespath = [pwd(), '/../figures/optnomap_vary_etalaw/'];
...
% Lower etaLAW to vary strike
s.etaLAW = s.etaLAW - .04;
s.color = 'b';
mppol2_s = s;
