...
% written by William Chen and Gregory Phelan, Jan. 2022
    ...
    if lc
        mu_theta = transfers_h - transfers_b - (xb - 1) * DS - liquidity_premium + sigma_ch * sigma_theta - ...
            xb * ((s.ab - s.ah) / Q - (-sigma_theta * ssQ + liquidity_premium));
        mu_eta   = xb * s.ab / Q - (xb - 1) * s.ah / Q - iota / Q ...
        ...
        mu_eta   = (s.ab - iota) / Q + transfers_b + (xb - 1) * ((sigma_ch - sigma_theta) - ssQ) * ssQ;
    end
    ...
    if lc
        % excess_returns = E[dr_b] - dr_d = (s.ab - s.ah) / Q + sigma_ch * ssQ + DS
        % and E[dr_b] - dr_d = risk_premium + liquidity_premium
        risk_premium = (s.ab - s.ah) / Q + sigma_ch * ssQ + DS - liquidity_premium;
