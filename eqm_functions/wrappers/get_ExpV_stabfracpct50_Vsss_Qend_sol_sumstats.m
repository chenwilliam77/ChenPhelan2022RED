function [ExpV, stab_frac, Vsss, Qend, sol, summary_stats] = get_ExpV_stabfracpct50_Vsss_Qend_sol_sumstats(input, s, input_type, varargin)
...
elseif strcmp(input_type, 'constpi')
    [s, converged] = find_constant_inflation_mp_rule(s, varargin);
    if ~converged
