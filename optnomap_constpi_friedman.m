...
%% Edits to plots
fignum = [1, 2, 22, 23, 6, 7, 8, 9, 10, 11, 12, 15, 16, 25, 26, 32, 33, 35, ...
    40, 41, 42, 43, 52, 55, 56, 57, 58]; % figures to save/edit in loops
save_fn = {'leverage', 'mu_eta', 'sigma_eta', 'psi', 'omega', 'sigma_Ch', 'sigma_theta', 'sigma_Q', 'Q', 'dr_f', 'welfare', ...
    'mu_Ch', 'mu_K', 'sharpe_ratio', 'excess_returns', 'nominal_interest', 'inflation', ...
    'risk_liquidity_premia', 'pdf', 'pdf_normalized', 'cdf', 'cdf_normalized', ...
    'deposit_spread', 'welfare_cons_pi_costs', 'welfare_cons', 'welfare_conv_yield', 'welfare_pi_costs'};
